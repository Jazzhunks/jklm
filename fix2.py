...
androidx-compose-material-icons = { group = "androidx.compose.material", name = "material-icons-extended", version.ref = "composeUi" }
...
androidx-print = { group = "androidx.print", name = "print", version.ref = "print" }
