...
# Replace old createStudent with createFullStudent
vm = vm.replace('fun createStudent(fullName: String, phone: String, courseId: String, branchId: String)',
...
vm = vm.replace('id = "", fullName = fullName, contactPhone = phone, courseId = courseId, branchId = branchId',
...
print("Students heavily upgraded")
