...
with open('/Users/mudasirmushtaq/Documents/app/northend/android-admin/app/src/main/java/com/northend/admin/ui/erp/ExpensesScreen.kt', 'w') as f:
    f.write("""package com.northend.admin.ui.erp
...
vm = vm.replace('fun createExpense(branchId: String, category: String, amount: Double, desc: String)',
                'fun createFullExpense(branchId: String, category: String, amount: Double, desc: String, vendor: String, pMode: String)')
vm = vm.replace('branchId = branchId, category = category, amount = amount, description = desc',
                'branchId = branchId, category = category, amount = amount, description = desc, vendor = vendor, paymentMode = pMode')
...
print("Expenses heavily upgraded")
