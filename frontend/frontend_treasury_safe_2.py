...
if "Wallet," not in content:
    content = content.replace("Banknote,", "Banknote, Wallet,")
...
# Add Treasury components ABOVE ErpPayments
treasury_components = """
...
"""
if "TreasuryView({" not in content:
    content = content.replace("export default function ErpPayments() {", treasury_components)
...
# Close the ledger block at the end of ErpPayments
old_end = """      )}
    </div>
