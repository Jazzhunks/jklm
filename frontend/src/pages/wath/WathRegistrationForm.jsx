                    ...
                    <div id="admit-card-block" className="py-2">
                      ...
                      <div className="mt-5 p-5 glass rounded-2xl border border-accent/25 space-y-4">
                        ...
                        <div className="flex flex-col gap-3">
                          <a href={`/admit-card/${submitted.application_no}?phone=${encodeURIComponent(submitted.phone || form.phone)}`} target="_blank" rel="noreferrer" data-testid="download-admit-card">
