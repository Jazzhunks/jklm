            ...
            <GlassPanel elevated className="p-7 relative overflow-hidden" data-testid="admit-card-result">
              <div className="relative">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a href={`/admt/${appData.application_no}?phone=${encodeURIComponent(appData.phone || phone)}`} target="_blank" rel="noreferrer" data-testid="download-fetched-admit">
              ...
              {!result.result_published ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <a href={`/res/${result.application_no}?phone=${encodeURIComponent(result.phone)}`} target="_blank" rel="noreferrer" data-testid="download-result-pdf">
                      <CTAPrimary className="rounded-full py-3 px-6"><FileText weight="bold" size={14}/> Download Result Card PDF</CTAPrimary>
                    </a>
                    <a href={`/admt/${result.application_no}?phone=${encodeURIComponent(result.phone)}`} target="_blank" rel="noreferrer" data-testid="download-admit-from-result">
