...
export default function ReceiptModal({ payment, student, onClose }) {
  ...
  const pdfDownloadUrl = `${API_BASE}/erp/payments/${payment.id}/receipt?format=${
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText(`${window.location.origin}/api/erp/payments/${payment.id}/receipt`);
