...
# 2. Add setEditPayment state
content = content.replace(
    'const [selectedReceipt, setSelectedReceipt] = useState(null);',
    'const [selectedReceipt, setSelectedReceipt] = useState(null);\n  const [editPayment, setEditPayment] = useState(null);'
)

# 3. Add PaymentEditModal component above default export, and render it at the bottom of the JSX
modal_code = """
...
content = content.replace("export default function ErpStudentDetail() {", modal_code)
