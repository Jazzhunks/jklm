...
public class LookupResponseJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<LookupResponse>() {
  ...
  override fun fromJson(reader: JsonReader): LookupResponse {
    ...
    if (mask0 == 0xfffffffd.toInt()) {
      ...
      val localConstructor: Constructor<LookupResponse> = this.constructorRef ?:
          LookupResponse::class.java.getDeclaredConstructor(String::class.java, Map::class.java,
